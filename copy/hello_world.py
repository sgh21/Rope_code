...
class MoveRope(tasks.BaseTask):
    ...
    def create(self, stage,scene:World.scene):
        ...
        self._rope_stiffness =0#0.1*0.01*0.01# *0.00001 nothing happened# *10**10 nothing happened#: mass*DIST_UNITS*DIST_UNITS/degrees/second/second
    ...
    def moveCube(self,step_size):
        ...
        if self._world.is_done("my_first_task"):
            ...
            # self._dynamicCubeR.set_world_pose(position=currentPositionR)
             ...
             velocityR =0.1*disVectorR/disVectorRNorm
        ...
        if  self._world.is_done("my_first_task"):
            ...
            velocityL = 0.1*disVectorL/disVectorLNorm
