...
# 加载第一个点云数据
point_cloud1 = np.load('D:/Documents/SoftwareDoc/isaac_sim/repData/pointcloud_0006.npy')  # 请替换为第一个点云文件的路径
# 加载第二个点云数据
point_cloud2 = np.load('D:/Documents/SoftwareDoc/isaac_sim/repData/label_0006.npy')  # 请替换为第二个点云文件的路径
...
# 绘制第一个点云
ax.scatter(point_cloud1[:, 0], point_cloud1[:, 1], point_cloud1[:, 2], c='b', label='Point Cloud 1')

# 绘制第二个点云
ax.scatter(point_cloud2[:, 0], point_cloud2[:, 1], point_cloud2[:, 2], c='r', label='Point Cloud 2')
